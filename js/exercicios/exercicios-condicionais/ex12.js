...
if (MA >= 90) {
  console.log(
    `${nome}, com matrícula ${id}, obteve conceito "A", média de aproveitamento ${MA} e foi APROVADO!`
  );
} else if (MA >= 75 && MA < 90) {
  console.log(
    `${nome}, com matrícula ${id}, obteve conceito "B", média de aproveitamento ${MA} e foi APROVADO!`
  );
} else if (MA >= 60 && MA < 75) {
  console.log(
    `${nome}, com matrícula ${id}, obteve conceito "C", média de aproveitamento ${MA} e foi APROVADO!`
  );
} else if (MA >= 40 && MA < 60) {
  console.log(
    `${nome}, com matrícula ${id}, obteve conceito "D", média de aproveitamento ${MA} e foi REPROVADO!`
  );
} else {
  console.log(
    `${nome}, com matrícula ${id}, obteve conceito "E", média de aproveitamento ${MA} e foi REPROVADO!`
  );
}
